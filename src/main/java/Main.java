public class Main {
    public static void main(String[] args) {
        new Runner(true).addTask(new Task("SeventhExpression",
                ...
                //::TODO accuracy doesn't seem to depend much on epsilon
                .addForRun("Parabolas", 1.E-15)

                //::TODO only works for eps = 10 ^ (- 8), too long for eps < 10 ^ (- 9), small precision for eps > 10 ^ (- 7)
                .addForRun("Brent", 1.E-8)
                .runTasks();
    }
}
